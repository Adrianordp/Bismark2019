...
hold on
plot(t,yliu,'k','linewidth',1)

axis([0 60 -0.2 1.2])

set(gca,'FontName','Times New Roman','FontSize',12)
legend({'Proposed','Geng et al. [XX]'},'FontName','Times New Roman','FontSize',12,'location','best')
grid
xlabel('Time (s)')
ylabel('Output')
...
f2 = figure(2)
loglog(w,Ir_bis,'r','linewidth',2)
hold on
loglog(w,Ir_geng,'k','linewidth',1)
...
leg1 = legend({'Proposed','Geng et al. [XX]','$\overline{\delta P}$'},'FontName','Times New Roman','FontSize',12,'location','best')
