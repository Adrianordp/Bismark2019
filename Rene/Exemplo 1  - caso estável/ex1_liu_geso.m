...
[nt,dt] = tfdata(Gt,'v');
 ...
 b0 = 0.8025;
 %bc = 0.9512
 bc = 0.95123;              % No artigo este valor foi arredondado
...
Kf = 0.2146*(z-bc)^2*z/((z-0.9047)*(z-lf)^nf);
...
Cp = [nt(2:end)];
 ...
 Gta = minreal(ss(Ap,Ap^10*Bp,Cp,0,Ts));
